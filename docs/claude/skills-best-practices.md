...
![Bundling executable scripts alongside instruction files](https://mintcdn.com/anthropic-claude-docs/4Bny2bjzuGBK7o00/images/agent-skills-executable-scripts.png?fit=max&auto=format&n=4Bny2bjzuGBK7o00&q=85&s=4bbc45f2c2e0bee9f2f0d5da669bad00)
...
- [Get started with Agent Skills](/en/docs/agents-and-tools/agent-skills/quickstart) — Create your first Skill.
- [Use Skills in Claude Code](/en/docs/claude-code/skills) — Create and manage Skills in Claude Code.
- [Use Skills with the API](/en/api/skills-guide) — Upload and use Skills programmatically.
